          ...
          <AnimatePresence>
            {activeMegaMenu && (
              <motion.div
                ...
                className="absolute left-0 right-0 top-[80px] w-full bg-white/75 backdrop-blur-3xl border-t border-slate-100 shadow-[0_30px_50px_-10px_rgba(0,0,0,0.08)] z-50 pointer-events-auto max-h-[calc(100vh-120px)] overflow-y-auto no-scrollbar"
